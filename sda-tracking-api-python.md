SDA Tracking API - Python
================================
Use Python to track SDA shipments with SDA Tracking API.
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': '3UW0H2H018366,3UW19XY000127', 'courier_code': 'italy-sda'}
